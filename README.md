...
2. 프론트 서버 실행
   - [배포된 사이트](https://wanted-pre-onboarding-frontend-3.vercel.app/)에 들어가시거나 아래의 과정을 실행해주세요 !
   ...
   - 프로젝트 다운로드가 끝났다면, 해당 디렉토리로 이동해 프로젝트에 필요한 패키지를 설치해주세요.
     ...
     npm install
     ```
   - 패키지 설치가 끝났다면, 다음 명령어를 사용해 프론트 서버를 실행시켜주세요 !
     ```
     npm start
     ```
4. 입력 방법
   ...
   - esc를 누르면 결과창이 닫힌다.
   - ❗한 글자를 입력했을 때 클릭이 잘 되지 않는다면, 엔터를 누르고 클릭 해주세요❗
